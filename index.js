...
(function() {
  var CompletedState, Covenant, FulfilledState, PendingState, Promise, RejectedState, bestTick, root,
  ...
  Promise = (function(_super) {
    ...
    function Promise() {
      ...
      this.resolver = __bind(this.resolver, this);      Promise.__super__.constructor.call(this);
    }
    ...
    Promise.delay = function(ms) {
      return Promise.makePromise(function(p) {
        return setTimeout(p.fulfill, ms);
      });
    };
