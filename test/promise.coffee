((define)-> define (require,root)->
  ...
  {covenantTestHelper} = (require './helpers/covenantTestHelper') ? root
  chai.use covenantTestHelper

  {Promise} = require('../promise') ? root
  {enqueue} = require('../covenant') ? root
  ...
  describe "Promise", ->
    ...
    describe "p.promise", ->
      it "should also recognize promise convenience functions", ->
        ...
        p.promise.fail.should.eql p.fail
